...
unique_loc <- venues %>% filter(!Name %in% duplicate_names)
...
fixed_venue <- full_venue %>%
  mutate(capacity = case_when(
    ...
    Name == "Wildcat Stadium" & round(Latitude, 2) == 32.53 ~ "10,000",
    Name == "Wildcat Stadium" & round(Latitude, 2) == 43.14 ~ "11,015",
    Name == "Wildcat Stadium" & round(Latitude, 2) == 32.47 ~ "12,000",
    Name == "War Memorial Stadium" & round(Latitude, 2) == 37.01 ~ "3,750",
    Name == "War Memorial Stadium" & round(Latitude, 2) == 36.08 ~ "7,500",
    Name == "War Memorial Stadium" & round(Latitude, 2) == 41.31 ~ "29,181",
    Name == "War Memorial Stadium" & round(Latitude, 2) == 34.75 ~ "54,120",
    Name == "Veterans Memorial Stadium" & round(Latitude, 2) == 41.97 ~ "5,300",
    Name == "Veterans Memorial Stadium" & round(Latitude, 2) == 31.80 ~ "30,000",
    Name == "Veterans Memorial Coliseum" & round(Latitude, 2) == 43.05 ~ "7,890",
    Name == "Veterans Memorial Coliseum" & round(Latitude, 2) == 45.53 ~ "9,122",
    Name == "University Stadium" & round(Latitude, 2) == 33.58 ~ "10,000",
    Name == "University Stadium" & round(Latitude, 2) == 35.07 ~ "37,440",
    Name == "Truist Stadium" & round(Latitude, 2) == 36.09 ~ "5,500",
    Name == "Truist Stadium" & round(Latitude, 2) == 36.08 ~ "21,500",
    Name == "Toyota Field" & round(Latitude, 2) == 34.68 ~ "5,500",
    Name == "Toyota Field" & round(Latitude, 2) == 29.54 ~ "8,400",
    Name == "Toyota Center" & round(Latitude, 2) == 29.75 ~ "18,023",
    Name == "Toyota Center" & round(Latitude, 2) == 46.22 ~ "5,785",
    Name == "Titan Stadium" & round(Latitude, 2) == 33.89 ~ "10,000",
    Name == "Titan Stadium" & round(Latitude, 2) == 44.02 ~ "9,800",
    Name == "The Coliseum" & round(Latitude, 2) == 33.58 ~ "7,000",
    Name == "The Coliseum" & round(Latitude, 2) == 32.71 ~ "3,890",
    Name == "Moody Coliseum" & round(Latitude, 2) == 32.47 ~ "3,600",
    Name == "Moody Coliseum" & round(Latitude, 2) == 32.84 ~ "7,000",
    Name == "Memorial Stadium" & round(Latitude, 2) == 40.82 ~ "90,000",
    Name == "Memorial Stadium" & round(Latitude, 2) == 38.96 ~ "71,168",
    Name == "Memorial Stadium" & round(Latitude, 2) == 40.12 ~ "60,670",
    Name == "Memorial Stadium" & round(Latitude, 2) == 41.83 ~ "13,742",
