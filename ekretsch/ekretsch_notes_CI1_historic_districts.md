...
# Dataset source:
## Dataset 1: NRHP Historic Landmarks
...
## Dataset 2: Census State Geographies
- https://www.census.gov/geographies/reference-files/2010/geo/state-area.html
- This is from 2010, but is the most complete+reliable since it is from the Census _and_ includes the 5 US territories
